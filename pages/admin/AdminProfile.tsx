...
import { User, Mail, Shield, ChevronRight, LogOut, ShoppingCart, Package, ChevronLeft, Settings, Edit2, X, Save, Loader2 } from 'lucide-react';
...
export default function AdminProfile() {
  ...
  const links = [
    { icon: ShoppingCart, label: 'Order Management', color: '#F59E0B', bg: '#FEF3C7', route: '/admin/orders' },
    { icon: Package, label: 'Inventory', color: '#22C55E', bg: '#E5F5EC', route: '/admin/inventory' },
  ];
       ...
       <div className="bg-primaryLight h-[200px] relative rounded-b-[32px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
             <div className="w-[120px] h-[120px] bg-primary rounded-[24px] border-[6px] border-backgroundSecondary flex items-center justify-center shadow-lg">
                <span className="text-white text-[48px] font-bold">AD</span>
             </div>
          </div>
       </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm mb-8 space-y-6">
             ...
             <div className="flex items-center gap-4">
                ...
                <div>
                   ...
                   <div className="font-bold text-textPrimary truncate max-w-[200px]">{user?.email}</div>
                </div>
             </div>
             ...
             <div className="flex items-center gap-4">
                ...
                <div>
                   <div className="text-xs text-textSecondary font-bold uppercase">Role</div>
                   <div className="font-bold text-textPrimary">Administrator</div>
                </div>
             </div>
          </div>
